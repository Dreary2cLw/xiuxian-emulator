...
import { player_efficiency, shijianc, timestampToTime } from '../Xiuxian/xiuxian.js';
...
export class AssociationAdmin extends plugin {
  ...
  async lvup_association(e) {
    ...
    if (ass.灵石池 < ass.宗门等级 * 500000 * xian) {
      e.reply(`本宗门目前灵石池中仅有${ass.灵石池}灵石,当前宗门升级需要${ass.宗门等级 * 500000 * xian}灵石,数量不足`);
      return;
    }

    ass.灵石池 -= ass.宗门等级 * 500000 * xian;
    ass.宗门等级 += 1;
    // if (ass.宗门等级 == 8) {
    //     let i = '';
    //     let homestudy = '';
