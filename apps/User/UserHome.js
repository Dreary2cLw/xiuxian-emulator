            ...
            if (isNotNull(x) && x > 0) {
                ...
                if (type == "武器") {
                    ...
                    if (equipment.武器.fumo != "无" && equipment.武器.fumo != null) {
                        await Add_najie_thing(usr_qq, equipment.武器.fumo, 道具, 1)
                    }
                ...
                if (type == "护具") {
                    ...
                    if (equipment.护具.fumo != "无" && equipment.武器.fumo != null) {
                        await Add_najie_thing(usr_qq, equipment.护具.fumo, 道具, 1)
                    }
                ...
                if (type == "法宝") {
                    ...
                    if (equipment.法宝.fumo != "无" && equipment.法宝.fumo != null) {
                        await Add_najie_thing(usr_qq, equipment.法宝.fumo, 道具, 1)
                    }
