    ...
    async Player_use(e) {
        ...
        if (func == "消耗") {
            ...
            if (thing_name == "书架") {
                ...
                e.reply("书架放置成功");
                await Write_player(usr_qq, player);
                await Add_najie_thing(usr_qq, "书架", "材料", -quantity);
                return
            }
            if (thing_name == "附魔台") {
                player.附魔台 = 1;
            ...
            if (thing_name == "低语森林") {
                ...
                if (futou > 0 || shifu > 0) {
                    ...
                    if (math > 0.01 && math <= 0.1) {
                        ...
                        await Add_najie_thing(usr_qq, "苹果", "食材", 100 * n);
                        e.reply(`${last_msg}${fyd_msg}你在低语森林捡到了原木${3 * futou * n + 9 * shifu * n}个和苹果${100 * n}个,获得了修为${xiuwei}血气${xueqi}`)
                        return;
                    } else if (math > 0.7 && math < 0.8) {
                        await Add_najie_thing(usr_qq, "泥土", "材料", 20 * n);
                        e.reply(`${last_msg}${fyd_msg}你在低语森林捡到了原木${3 * futou * n + 9 * shifu * n}个和泥土${20 * n}个,获得了修为${xiuwei}血气${xueqi}`)
                        return;
                    } else if (math > 0.6 && math < 0.7) {
                        await Add_najie_thing(usr_qq, "树苗", "食材", 2 * n);
                        e.reply(`${last_msg}${fyd_msg}你在低语森林捡到了原木${3 * futou * n + 9 * shifu * n}个和树苗${2 * n}个,获得了修为${xiuwei}血气${xueqi}`)
                        return;
                    } else {
            ...
            if (thing_name == "水天丛林") {
                ...
                if (futou > 0 || shifu > 0) {
                    ...
                    if (math > 0.8 && math < 0.9) {
                        await Add_najie_thing(usr_qq, "西瓜", "食材", 256 * n);
                        e.reply(`${last_msg}${fyd_msg}你在水天丛林捡到了原木${5 * futou * n + 15 * shifu * n}个和西瓜${256 * n},获得了修为${xiuwei}血气${xueqi}`)
                        return;
                    } else if (math > 0.7 && math < 0.8) {
                        await Add_najie_thing(usr_qq, "泥土", "材料", 40 * n);
                        e.reply(`${last_msg}${fyd_msg}你在水天丛林捡到了原木${5 * futou * n + 15 * shifu * n}个和泥土${40 * n},获得了修为${xiuwei}血气${xueqi}`)
                        return;
                    } else if (math > 0.7 && math < 0.8) {
                        await Add_najie_thing(usr_qq, "树苗", "食材", 5 * n);
                        e.reply(`${last_msg}${fyd_msg}你在水天丛林捡到了原木${5 * futou * n + 15 * shifu * n}个和树苗${10 * n},获得了修为${xiuwei}血气${xueqi}`)
                        return;
                    } else if (math > 0.6 && math < 0.7) {
                        await Add_najie_thing(usr_qq, "甘蔗", "食材", 18 * n);
                        e.reply(`${last_msg}${fyd_msg}你在水天丛林捡到了原木${5 * futou * n + 15 * shifu * n}个和甘蔗${18 * n},获得了修为${xiuwei}血气${xueqi}`)
                        return;
                    } else {
            ...
            if (thing_name == "轻策庄") {
                ...
                if (muchan > 0 || shichan > 0 || zuanshichan > 0) {
                    ...
                    if (isNotNull(muchan) && muchan > 0) {
                        muchan = 1
                        await Add_najie_thing(usr_qq, "胡萝卜", "食材", 300 * muchan * n);
                        await Add_najie_thing(usr_qq, "土豆", "食材", 300 * muchan * n);
                    ...
                    if (isNotNull(shichan) && shichan > 0) {
                        shichan = 1
                        await Add_najie_thing(usr_qq, "胡萝卜", "食材", 600 * shichan * n);
                        await Add_najie_thing(usr_qq, "土豆", "食材", 600 * shichan * n);
                    ...
                    if (isNotNull(zuanshichan) && zuanshichan > 0) {
                        zuanshichan = 1
                        await Add_najie_thing(usr_qq, "胡萝卜", "食材", 900 * zuanshichan * n);
                        await Add_najie_thing(usr_qq, "土豆", "食材", 900 * zuanshichan * n);
                    ...
                    if (math > 0.9 && math <= 1) {
                        ...
                        e.reply(`${last_msg}${fyd_msg}你在轻策庄捡到了胡萝卜${300 * muchan * n + 600 * n * shichan + 900 * n * zuanshichan}个和土豆${300 * muchan * n + 600 * n * shichan + 900 * n * zuanshichan}个和小麦${1000 * muchan * n + 1000 * shichan * n + 2000 * zuanshichan * n}个和铁矿${3 * n},获得了修为${xiuwei}血气${xueqi}`)
                        return;
                    } else if (math > 0.8 && math <= 0.9) {
                        ...
                        e.reply(`${last_msg}${fyd_msg}你在轻策庄捡到了胡萝卜${300 * muchan * n + 600 * n * shichan + 900 * n * zuanshichan}个和土豆${300 * muchan * n + 600 * n * shichan + 900 * n * zuanshichan}个和小麦${1000 * muchan * n + 1000 * shichan * n + 2000 * zuanshichan * n}个和黑曜石${5 * n},获得了修为${xiuwei}血气${xueqi}`)
                        return;
                    } else {
                        e.reply(`${last_msg}${fyd_msg}你在轻策庄捡到了胡萝卜${300 * muchan * n + 600 * n * shichan + 900 * n * zuanshichan}个和土豆${300 * muchan * n + 600 * n * shichan + 900 * n * zuanshichan}个和小麦${1000 * muchan * n + 1000 * shichan * n + 2000 * zuanshichan * n}个,获得了修为${xiuwei}血气${xueqi}`)
                        return;
                    }
                } else {
                    e.reply('你想起来你没有铲子,于是又回家了')
            ...
            if (thing_name == "层岩巨渊") {
                ...
                if (muchan > 0 || shichan > 0 || zuanshichan > 0) {
                    ...
                    if (math > 0.9 && math <= 1) {
                        ...
                        if (heiyaoshi == true) {
                            e.reply(`${last_msg}${fyd_msg}你在层岩巨渊挖到圆石${18 * muchan * n + 18 * shichan * n + 18 * zuanshichan * n}个,
        ...
        if (func == "合成") {
            ...
            for (let i = 0; i < wupin.materials.length; i++) {
                ...
                if (x < material.amount * quantity) {
                    e.reply(`纳戒中拥有${x}份${material.name}，合成需要${material.amount * quantity}份`);
                    return;
                }
            }
            //纳戒中减去对应物品
